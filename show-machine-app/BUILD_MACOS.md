...
- **Apple Silicon DMG**: `dist/Open Clicker Show Machine-1.8.1-arm64.dmg`
- **Apple Silicon ZIP**: `dist/Open Clicker Show Machine-1.8.1-arm64-mac.zip`
...
echo "  - Apple Silicon DMG: dist/Open Clicker Show Machine-1.8.1-arm64.dmg"
echo "  - Apple Silicon ZIP: dist/Open Clicker Show Machine-1.8.1-arm64-mac.zip"
```
...
```bash
npm run build:mac
xcrun notarytool submit dist/Open\ Clicker\ Show\ Machine-1.8.1-x64.dmg \
