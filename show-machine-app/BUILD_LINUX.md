...
- **AppImage**: `dist/Open Clicker Show Machine-1.8.1.AppImage`
...
echo "  - AppImage: dist/Open Clicker Show Machine-1.8.1.AppImage"
echo ""
echo "To run:"
echo "  chmod +x dist/Open\ Clicker\ Show\ Machine-1.8.1.AppImage"
echo "  ./dist/Open\ Clicker\ Show\ Machine-1.8.1.AppImage"
```
...
```bash
chmod +x "Open Clicker Show Machine-1.8.1.AppImage"
./Open\ Clicker\ Show\ Machine-1.8.1.AppImage
```
...
3. Run your built AppImage:
   ```bash
   chmod +x dist/Open\ Clicker\ Show\ Machine-1.8.1.AppImage
   ./dist/Open\ Clicker\ Show\ Machine-1.8.1.AppImage
   ```
...
```bash
GDK_BACKEND=x11 ./Open\ Clicker\ Show\ Machine-1.8.1.AppImage
```
