...
- **Portable**: `Open Clicker Show Machine-1.8.1-portable.exe` - No installation required, just run it
- **Installer**: `Open Clicker Show Machine Setup 1.8.1.exe` - Traditional Windows installer with Start Menu shortcut

### macOS

Two versions are available:
- **DMG (Apple Silicon)**: `Open Clicker Show Machine-1.8.1-arm64.dmg` - Disk image for M1/M2/M3/M4 Macs
- **ZIP (Apple Silicon)**: `Open Clicker Show Machine-1.8.1-arm64-mac.zip` - Zip archive for M1/M2/M3/M4 Macs
...
- **AppImage (x64)**: `Open Clicker Show Machine-1.8.1.AppImage` - Portable Linux application
...
1. Download and run `Open Clicker Show Machine-1.8.1-portable.exe`
...
- `Open Clicker Show Machine-1.8.1-arm64.dmg` (Apple Silicon)
- `Open Clicker Show Machine-1.8.1-arm64-mac.zip` (Apple Silicon)
...
- `Open Clicker Show Machine-1.8.1.AppImage` (x64)
...
4. **Find Your Executable**
   ...
   - Portable: `Open Clicker Show Machine-1.8.1-portable.exe`
   - Installer: `Open Clicker Show Machine Setup 1.8.1.exe`
