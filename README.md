...
3. **Show Machine**: On the computer running your presentation:
   ...
   **Option 1 - Standalone Desktop App (Recommended - Windows/macOS/Linux)**
   - **Windows**: Download `Open Clicker Show Machine-1.8.0-portable.exe` from [Releases](https://github.com/dgoran/open-clicker/releases)
...
1. Download from [Releases](https://github.com/dgoran/open-clicker/releases)
   - Portable: `Open Clicker Show Machine-1.8.0-portable.exe` (no installation)
   - Installer: `Open Clicker Show Machine Setup 1.8.0.exe` (traditional installer)
2. Run the app
